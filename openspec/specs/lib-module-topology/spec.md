# Lib Module Topology Specification

> Canonical folder structure for all modules under `src/lib`.

## Purpose

Define the five top-level folders that organize every core library module by business ownership or platform role, and retire legacy implementation-layer buckets.
