# extension-spotify-client Specification

## Purpose
Typed Spotify client module inside the Chrome extension that wraps Pathfinder reads/mutations and Playlist v2 delta operations behind method-level contracts, providing a unified API surface for all extension-executed Spotify operations.
