...
import {
	...
	DescriptionTeachingBullets,
	DescriptionTeachingHeadline,
} from "./DescriptionTeachingShared";
...
function pickExample(): string {
	return DESCRIPTION_EXAMPLES[
		Math.floor(Math.random() * DESCRIPTION_EXAMPLES.length)
	];
}
...
export function DescriptionRoleDialog({ onClose }: DescriptionRoleDialogProps) {
	...
	return createPortal(
		<div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
			...
			>
				<DescriptionTeachingHeadline id="description-role-title" />

				<p
					className="theme-text mb-6 text-sm leading-relaxed text-pretty"
					style={{ fontFamily: fonts.body }}
				>
					Write a description to set the intent of this playlist. Mix any of
					these: a moment, a feeling, a sound, a genre.
				</p>
