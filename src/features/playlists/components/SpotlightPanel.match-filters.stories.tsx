...
/**
 * The match-filters feature as it lands inside the existing SpotlightPanel
 * composable — the drawer that owns matchFilters draft state and the CMHF-14
 * options seam. The base (filter-free) panel lives under
 * Playlists/Explorations/Composable.
 */
export default { title: "Match Filters/Composable/SpotlightPanel" };
