		...
		>
			...
			{onClearFilters && (
				<button
					...
					className="chip-raised chip-raised-hover squircle focus-edge inline-flex flex-none cursor-pointer items-center whitespace-nowrap rounded-full px-3 py-1.5 text-[11px] tracking-widest uppercase active:scale-[0.98]"
