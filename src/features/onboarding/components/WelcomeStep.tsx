		...
		<>
			<div className="text-center">
				...
				<button
					...
					type="button"
					className="group mt-16 inline-flex min-h-11 cursor-pointer items-center gap-3 border border-transparent px-4 py-2 transition-opacity duration-150 active:scale-[0.98]"
					style={{
