...
export const songs: Song[] = [
	{
		...
		artist: 'Lorde',
		album: 'Pure Heroine',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273187331e276c898d39764cc98',
		keyLines: [
			{
				text: "I've never felt more alone",
				meaning: 'The isolating realization that growing up means growing apart.',
			},
			{
		...
		culturalNote: 'A generation-defining anthem about the terror and beauty of youth.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273001d5706fddc72561f6488af',
		keyLines: [
			{
				text: 'I come and I go',
				meaning: 'Asserting independence and unpredictability in relationships.',
			},
			{
		...
		culturalNote: "Part of Dua's evolution into disco-pop territory with a defiant edge.",
		journey: [
			{
				section: 'Intro',
			...
			{ section: 'Outro', mood: 'Liberating fade', description: "She's already gone." },
		],
	},
	{
		id: 3,
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b2737aede4855f6d0d738012e2e5',
		keyLines: [
			{
		...
		tempo: 68,
		energy: 0.35,
		bestMoments: ['Missing someone at 2am', 'Rainy day reflection', 'Quiet heartache'],
		culturalNote: 'A masterclass in falsetto vulnerability that redefined R&B intimacy.',
		journey: [
			{
				section: 'Intro',
				mood: 'Gentle ache',
	...
	},
	{
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b27368b90c3b34c3ac22856ddab8',
		keyLines: [
			{
		...
		tempo: 98,
		energy: 0.45,
		bestMoments: ['Processing toxic relationships', 'Late night venting', 'Angry crying'],
		culturalNote:
	...
	},
	{
		...
		artist: 'Hozier',
		album: 'Unheard',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273be392334d99f82bc410cb239',
		keyLines: [
			{
	...
	},
	{
		...
		tempo: 85,
		energy: 0.58,
		bestMoments: ["2am texts you shouldn't send", 'Seeing an ex', 'Drunk confessions'],
	...
	},
	{
		...
		artist: 'SZA',
		album: 'SOS',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273c5276ed6cb0287df8d9be07f',
		keyLines: [
			{
		...
		culturalNote: 'A Tarantino-referencing revenge fantasy wrapped in velvet vocals.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		journey: [
			...
			{ section: 'Outro', mood: 'Victory secured', description: 'The case is closed.' },
		],
	},
	{
		id: 9,
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273357b215562c3268ed1022942',
		keyLines: [
			{
				text: 'I want to be crucified',
				meaning: 'Martyrdom as escape from mundane responsibility.',
			},
			{ text: 'Filing my taxes', meaning: 'The crushing banality of adult obligation.' },
			{
		...
		tempo: 142,
		energy: 0.78,
		bestMoments: ['Tax season meltdowns', 'Questioning adulthood', 'Absurdist rage'],
		culturalNote: '2025 breakout that turned paperwork into existential theater.',
		journey: [
			{
				section: 'Intro',
			...
			{ section: 'Chorus', mood: 'Operatic release', description: 'The sky rips open.' },
			{
				section: 'Bridge',
	...
	},
	{
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273bef221ea02a821e7feeda9cf',
		keyLines: [
			{
		...
		culturalNote: 'A prayer disguised as a pop song that resonated with millions.',
		journey: [
			{
				section: 'Intro',
				mood: 'Gentle plea',
	...
	},
	{
		...
		tempo: 105,
		energy: 0.52,
		bestMoments: ['Deep conversations', 'Found family moments', 'Quiet love confessions'],
		culturalNote: '#2 song globally in both 2024 and 2025 — a modern love anthem.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		album: 'SOUR',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b2738ffc294c1c4362e8472d14cd',
		keyLines: [
			{
		...
		culturalNote: 'The breakup ballad that broke Spotify records and launched a career.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b27396fa88fb1789be437d5cb4b6',
		keyLines: [
			{
		...
		tempo: 128,
		energy: 0.85,
		bestMoments: ['Coming out moments', 'Pride celebrations', 'Choosing yourself'],
	...
	},
	{
		...
		album: 'IGOR',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b27330a635de2bb0caa4e26f6abb',
		keyLines: [
			{
		...
		culturalNote: "Tyler's pivot to vulnerable love songs that redefined his artistry.",
		journey: [
			{
				section: 'Intro',
				mood: 'Synth haze',
	...
	},
	{
		...
		keyLines: [
			...
			{ text: "Sin City's cold and empty", meaning: 'Success without love is hollow.' },
			{
		...
		culturalNote: 'The most streamed song in Spotify history — 5+ billion plays.',
		journey: [
			{
				section: 'Intro',
				mood: '80s neon pulse',
	...
	},
	{
		...
		keyLines: [
			...
			{ text: "In this world, it's just us", meaning: 'Isolation within intimacy.' },
			{
	...
	},
	{
		...
		album: 'Manchild',
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b273062c6573009fdebd43de443b',
		keyLines: [
			{ text: "You're a manchild", meaning: 'Calling out emotional immaturity.' },
			{
				text: 'Throwing tantrums in a restaurant',
				meaning: "Public embarrassment from partner's behavior.",
			},
			{ text: 'I need a man, not a fan', meaning: 'Wanting partnership, not worship.' },
		],
		themes: [
		...
		culturalNote: '2025 song of the summer — sharp, funny, and devastatingly relatable.',
		journey: [
			{
				section: 'Intro',
				mood: 'Playful setup',
			...
			{ section: 'Verse 2', mood: 'More receipts', description: "Oh, there's more." },
			{ section: 'Outro', mood: 'Case closed', description: "She's done explaining." },
		],
	},
	{
		id: 18,
		...
		tempo: 77,
		energy: 0.45,
		bestMoments: ['Counting blessings', 'Reflecting on success', 'Keeping perspective'],
		culturalNote: 'The video gave away nearly a million dollars — generosity as content.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		keyLines: [
			...
			{ text: 'Boricua de corazón', meaning: 'Puerto Rican identity as core self.' },
		],
		themes: [
		...
		culturalNote: 'The biggest streaming week for a Latin song in Spotify history.',
		journey: [
			{
				section: 'Intro',
	...
	},
	{
		...
		albumArtUrl: 'https://i.scdn.co/image/ab67616d0000b2731dac3694b3289cd903cb3acf',
		keyLines: [
			{ text: "I heard you're an actor", meaning: 'Calling out inauthentic behavior.' },
			{ text: "That's so true, bestie", meaning: 'Sarcastic agreement that stings.' },
			{ text: 'You played the victim', meaning: 'Exposing manipulative patterns.' },
		],
		themes: [
		...
		culturalNote: 'Her first billion-stream song — scathing honesty that went viral.',
		journey: [
			{
				section: 'Intro',
				mood: 'Quiet setup',
			...
			{ section: 'Outro', mood: 'Case closed', description: 'She said what she said.' },
		],
	},
]
...
export const getSpotifyTrackIds = (): string[] => songs.map(s => s.spotifyTrackId)

// Fallback placeholder image generator
export const getPlaceholderImage = (spotifyTrackId: string, size = 400): string =>
...
export const initialUserPlaylists = [
	...
	},
	{
		...
		description: 'an escape through the caverns of silence, into the beauty of stillness',
		lastUpdated: 'Apr 4',
		flagged: false,
	},
	{
