...
export const lyricalV12: PromptVersion = {
	version: "12",
	kind: "lyrical",
	notes:
		"Identical to v11 (the leading warm + dash-free candidate) plus one new lever: a closing self-audit checklist. v11 proved warm clean output is achievable but variance is the problem (same prompt ranged 0 to 8 high). No prior version asked the model to edit its own output. v12 appends a final 'reread and fix' pass for the four tells (comma+-ing, framing openers, dashes, self-reference) — an inline, free version of the handoff's rewrite second-pass. Clean A/B on the self-audit lever; everything above it matches v11 verbatim.",
...
One last pass before you answer. Reread every field once as an editor, because these four slip in under pressure. Fix each one you find.
1. A comma followed by a word ending in "-ing". Split it into two sentences.
2. A field that opens with "This is", "It is", or "This song is". Delete the opener and start with the noun.
3. Any hyphen or dash. Replace it with two plain words or a period.
4. The words "this song", "the track", "the narrator", "the singer". Remove them and name what happens instead.
Then return the corrected JSON.`,
};
