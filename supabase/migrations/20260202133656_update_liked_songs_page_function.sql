-- Update RPC function to return song_artist_ids for efficient artist image caching
-- Enables cache-by-artistId instead of cache-by-trackId, reducing duplicate API calls

-- Drop existing function (signature changes with new return column)
DROP FUNCTION IF EXISTS get_liked_songs_page(UUID, TIMESTAMPTZ, INT, TEXT);
