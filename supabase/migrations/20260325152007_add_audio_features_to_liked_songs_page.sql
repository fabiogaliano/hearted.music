-- Add audio features (tempo, energy, valence) to the liked songs page RPC
-- by joining song_audio_feature table.
-- Must drop first because return type is changing (adding 3 columns).
