...
| 008 | Audio features               | Separate `song_audio_feature` table                                                 | Different source (ReccoBeats API) and lifecycle; keeps `song` lean; missing features = missing row, not NULLs                                                                           |
