...
> `deck-read-model-plan.md` (which supersedes the request-path tiers in
...
---
*See also: `progressive-match-feed.md`, `architecture.md` · Build plan: `claudedocs/match-perf-root-cause-refactor.md`*
