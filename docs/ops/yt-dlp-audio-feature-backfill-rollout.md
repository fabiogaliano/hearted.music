...
its control-panel review center. The original implementation plan has shipped;
the code under `src/worker/poll-audio-feature-backfill.ts` and the enrichment
pipeline are now the source of truth.
